...
namespace SoulsFormats
{
    ...
    {
        /// <summary>
        /// Shallow Copy Constructor for BinderFile
        /// </summary>
        public BinderFile(BinderFile oldBinder)
        {
            Flags = oldBinder.Flags;
            ID = oldBinder.ID;
            Name = oldBinder.Name;
            Bytes = oldBinder.Bytes;
            CompressionType = oldBinder.CompressionType;
        }
        /// <summary>
